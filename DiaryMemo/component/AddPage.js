...
// ---- id = 1 -----------------------------------------
    		<View style = {{flex: 1,}}>
				...
				<View style={styles.imageView}>
				    ...
				    <View style = {{}}>
					    <TouchableHighlight activeOpacity={0.6} underlayColor='hsla(210, 90%, 0, 0.1)'>
					    	<Icon
